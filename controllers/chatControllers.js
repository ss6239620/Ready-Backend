...
const chatroomexist = async (req, res) => {
    try {
...
const getalluserchatrooms = async (req, res) => {
    try {
...
module.exports = { createchatroom, chatroomexist, getalluserchatrooms, sendmessage, getallmessage, getchatroomdetails }